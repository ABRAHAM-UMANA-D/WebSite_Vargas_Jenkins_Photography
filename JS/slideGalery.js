...
var inc = 0;
margin = 0;
var slider = document.getElementsByClassName("group-items")[0];
var itemDisplay = 0;
if (screen.width > 990) {
...
if (screen.width > 280 && screen.width < 700) {
    itemDisplay = document.getElementsByClassName("pictures-galery")[0].getAttribute("item-display-m");
    margin = itemDisplay * 20;
}

var items = document.getElementsByClassName("image-single");
